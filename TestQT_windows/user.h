...
{
public:
    user( mathmodel* com_math_model, avtopilot* come_system_avtomatic, std::vector<Tpoint> come_waypoints);
       ...
       void Change_mode(float vector[],float inTime);// процедура обработки данных и управление в зависимости от режима управления
